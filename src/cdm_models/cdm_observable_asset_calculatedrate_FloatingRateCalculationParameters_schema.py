...
class FloatingRateCalculationParameters(BaseModel):
    ...
    observation_parameters: cdm_observable_asset_calculatedrate_ObservationParameters_schema.ObservationParameters | None = Field(
        None, alias="observationParameters", description=" any applicable observation parameters, such as daily caps or floors."
    )
