...
class CustodyArrangements(BaseModel):
    ...
    other_provisions: str | None = Field(None, alias="otherProvisions", description="Other Custom Provisions of Custody Arrangements.")
    collateral_access_breach: cdm_legaldocumentation_csa_CollateralAccessBreach_schema.CollateralAccessBreach | None = Field(
        None, alias="collateralAccessBreach", description="The elections specific to Collateral Access Breach language."
    )
