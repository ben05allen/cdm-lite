...
class DisputeResolution(BaseModel):
    ...
    other_terms: str | None = Field(
        None, alias="otherTerms", description="The custom Resolution Time election that might be specified by the parties."
    )
    ...
    legacy_alternative: cdm_legaldocumentation_csa_LegacyResolutionAlternative_schema.LegacyResolutionAlternative | None = Field(
        None,
