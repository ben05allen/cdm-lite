...
class PortfolioReturnTerms(BaseModel):
    ...
    quantity: (
        cdm_base_math_metafields_ReferenceWithMetaNonNegativeQuantitySchedule_schema.ReferenceWithMetaNonNegativeQuantitySchedule | None
    ) = Field(None, description="Specifies a quantity schedule for the underlier, which applies to each individual return leg.")
