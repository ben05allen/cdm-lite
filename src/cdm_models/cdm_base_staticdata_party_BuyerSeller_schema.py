...
#   filename:  cdm-base-staticdata-party-BuyerSeller.schema.json
...
class BuyerSeller(BaseModel):
    buyer: cdm_base_staticdata_party_CounterpartyRoleEnum_schema.CounterpartyRoleEnum = Field(
        ...,
    ...
    seller: cdm_base_staticdata_party_CounterpartyRoleEnum_schema.CounterpartyRoleEnum = Field(
        ...,
