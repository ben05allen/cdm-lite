...
#   filename:  cdm-product-collateral-CollateralAgreementFloatingRate.schema.json
...
class CollateralAgreementFloatingRate(BaseModel):
    ...
    negative_interest: bool = Field(
        ...,
        alias="negativeInterest",
    ...
    compressible_spread: bool = Field(
        ...,
        alias="compressibleSpread",
