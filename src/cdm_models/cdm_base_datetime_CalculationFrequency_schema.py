...
class CalculationFrequency(BaseModel):
    ...
    month_of_year: float | None = Field(None, alias="monthOfYear", description="Specifies the month of the year if used.")
    ...
    week_of_month: float | None = Field(None, alias="weekOfMonth", description="Specifies the week of the month if used.")
    ...
    business_center: list[cdm_base_datetime_BusinessCenterEnum_schema.BusinessCenterEnum] | None = Field(
        None, alias="businessCenter", description="Specifies the business center for adjustment of calculation period.", min_length=0
    )
