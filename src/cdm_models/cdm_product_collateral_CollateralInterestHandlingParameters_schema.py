...
class CollateralInterestHandlingParameters(BaseModel):
    ...
    payment_business_center: list[cdm_base_datetime_BusinessCenterEnum_schema.BusinessCenterEnum] | None = Field(
        None, alias="paymentBusinessCenter", description="Specifies applicable business centers for payments.", min_length=0
    )
    ...
    interest_amount_application: cdm_product_collateral_InterestAmountApplication_schema.InterestAmountApplication | None = Field(
        None,
    ...
    interest_rollover_limit: cdm_base_math_NumberBound_schema.NumberBound | None = Field(
        None, alias="interestRolloverLimit", description="Specifies the level below which the interest will be rolled over."
    )
    ...
    alternative_to_interest_amount: cdm_product_collateral_AlternativeToInterestAmountEnum_schema.AlternativeToInterestAmountEnum | None = (
    ...
    notification: cdm_product_collateral_CollateralInterestNotification_schema.CollateralInterestNotification | None = Field(
        None, description="Specifies the terms describing notification requirements."
    )
