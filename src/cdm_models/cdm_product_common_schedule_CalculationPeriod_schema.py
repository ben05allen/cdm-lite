...
class CalculationPeriod(BaseModel):
    ...
    unadjusted_start_date: str | None = Field(
        None, alias="unadjustedStartDate", description="The calculation start date, unadjusted."
    )
    unadjusted_end_date: str | None = Field(
        None, alias="unadjustedEndDate", description="The calculation end date, unadjusted."
    )
