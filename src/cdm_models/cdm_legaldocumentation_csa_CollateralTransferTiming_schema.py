...
from . import cdm_legaldocumentation_csa_LegacyDefinition_schema, cdm_legaldocumentation_csa_LegacyTransferSettlementTiming_schema


class CollateralTransferTiming(BaseModel):
    transfer_settlement_timing: cdm_legaldocumentation_csa_LegacyTransferSettlementTiming_schema.LegacyTransferSettlementTiming | None = (
        Field(
            None,
