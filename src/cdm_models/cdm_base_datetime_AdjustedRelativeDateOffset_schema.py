...
class AdjustedRelativeDateOffset(BaseModel):
    ...
    date_relative_to: com_rosetta_model_metafields_ReferenceWithMetaString_schema.ReferenceWithMetaString | None = Field(
        None,
    ...
    relative_date_adjustments: cdm_base_datetime_BusinessDayAdjustments_schema.BusinessDayAdjustments | None = Field(
        None,
