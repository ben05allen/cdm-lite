...
class AgreementTerms(BaseModel):
    ...
    counterparty: list[cdm_base_staticdata_party_Counterparty_schema.Counterparty] | None = Field(
        None, description="Specification of the roles of the counterparties to the agreement.", max_length=2, min_length=2
    )
...
class Agreement(BaseModel):
    ...
    collateral_transfer_agreement_elections: (
        cdm_legaldocumentation_csa_CollateralTransferAgreementElections_schema.CollateralTransferAgreementElections | None
    ) = Field(None, alias="collateralTransferAgreementElections", description="Elections to specify a Collateral Transfer Agreement.")
    security_agreement_elections: cdm_legaldocumentation_csa_SecurityAgreementElections_schema.SecurityAgreementElections | None = Field(
        None, alias="securityAgreementElections", description="Elections to specify a Security agreement."
    )
    master_agreement_schedule: cdm_legaldocumentation_master_MasterAgreementSchedule_schema.MasterAgreementSchedule | None = Field(
        None, alias="masterAgreementSchedule", description="Elections to specify a Master Agreement Schedule."
    )
    transaction_additional_terms: cdm_legaldocumentation_transaction_TransactionAdditionalTerms_schema.TransactionAdditionalTerms | None = (
        Field(
            None,
    ...
    master_agreement_elections: MasterAgreementElections | None = Field(
        None, alias="masterAgreementElections", description="A legal representation of the different possible master agreements"
    )
...
class LegalAgreement(BaseModel):
    ...
    contractual_party: list[cdm_base_staticdata_party_metafields_ReferenceWithMetaParty_schema.ReferenceWithMetaParty] | None = Field(
        None,
...
class CreditSupportDocumentElection(BaseModel):
    ...
    credit_support_document_terms: cdm_legaldocumentation_common_CreditSupportDocumentTermsEnum_schema.CreditSupportDocumentTermsEnum = (
        Field(..., alias="creditSupportDocumentTerms", description="Specification of the Credit Support Document terms.")
    )
    ...
    credit_support_document: list[LegalAgreement] | None = Field(
        None, alias="creditSupportDocument", description="The specified Credit Support Document(s), if any.", min_length=0
    )
    bespoke_credit_suppport_document: str | None = Field(
        None, alias="bespokeCreditSuppportDocument", description="Specification of a document when not captured under RelatedAgreement."
    )
...
class MasterAgreementElections(BaseModel):
    isla_gmsla: (
        cdm_legaldocumentation_master_isla_GlobalMasterSecuritiesLendingAgreement_schema.GlobalMasterSecuritiesLendingAgreement | None
    ) = Field(None, alias="islaGmsla", description="The set of elections that define a GMSLA.")
    icma_gmra: cdm_legaldocumentation_master_icma_GlobalMasterRepoAgreement_schema.GlobalMasterRepoAgreement | None = Field(
        None, alias="icmaGmra", description="The set of elections that define a GMRA."
    )
...
class MasterAgreement(BaseModel):
    ...
    specified_entities: list[cdm_legaldocumentation_master_isda_SpecifiedEntities_schema.SpecifiedEntities] | None = Field(
        None,
