...
class CollateralTaxonomyValue(BaseModel):
    ...
    us_cftc_pr_eligible_collateral: (
        list[cdm_base_staticdata_asset_common_US_CFTC_PR_EligibleCollateralEnum_schema.USCFTCPREligibleCollateralEnum] | None
    ) = Field(
        None,
    ...
    non_enumerated_taxonomy_value: list[com_rosetta_model_metafields_FieldWithMetaString_schema.FieldWithMetaString] | None = Field(
        None,
