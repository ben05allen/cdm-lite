...
class CalculationAndTiming(BaseModel):
    calculation_agent_terms: cdm_legaldocumentation_csa_CalculationAgentTerms_schema.CalculationAgentTerms | None = Field(
        None, alias="calculationAgentTerms", description="The calculation agent terms applicable to the agreement."
    )
    bespoke_calculation_date: cdm_legaldocumentation_csa_BespokeCalculationDate_schema.BespokeCalculationDate | None = Field(
        None,
    ...
    bespoke_calculation_time: cdm_legaldocumentation_csa_BespokeCalculationTime_schema.BespokeCalculationTime | None = Field(
        None,
    ...
    calculation_date_location: cdm_legaldocumentation_csa_CalculationDateLocation_schema.CalculationDateLocation | None = Field(
        None,
    ...
    collateral_valuation_agent: cdm_legaldocumentation_csa_CollateralValuationAgent_schema.CollateralValuationAgent | None = Field(
        None, alias="collateralValuationAgent", description="The bespoke Collateral Valuation Agent terms applicable to the agreement."
    )
