...
#   filename:  cdm-base-staticdata-asset-common-InstrumentBase.schema.json
...
class InstrumentBase(BaseModel):
    ...
    instrument_type: cdm_base_staticdata_asset_common_InstrumentTypeEnum_schema.InstrumentTypeEnum = Field(
        ..., alias="instrumentType", description="Identifies the type of an instrument using an enumerated list."
    )
