...
#   filename:  cdm-event-common-MarginCallBase.schema.json
...
class MarginCallBase(BaseModel):
    instruction_type: cdm_event_common_MarginCallInstructionType_schema.MarginCallInstructionType = Field(
        ...,
    ...
    call_agreement_type: cdm_legaldocumentation_common_AgreementName_schema.AgreementName = Field(
        ..., alias="callAgreementType", description="Specifies the legal agreement type the margin call is generated from and governed by."
    )
