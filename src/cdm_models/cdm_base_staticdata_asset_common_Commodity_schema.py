...
class Commodity(BaseModel):
    ...
    commodity_product_definition: cdm_base_staticdata_asset_common_CommodityProductDefinition_schema.CommodityProductDefinition | None = (
        Field(
            None,
    ...
    delivery_date_reference: cdm_base_staticdata_asset_common_DeliveryDateParameters_schema.DeliveryDateParameters | None = Field(
        None,
    ...
    description: str | None = Field(None, description="Provides additional information about the commodity underlier.")
