...
from . import cdm_legaldocumentation_csa_AmendmentEffectiveDate_schema, cdm_legaldocumentation_csa_TerminationCurrencyElection_schema
...
class TerminationCurrencyAmendment(BaseModel):
    ...
    party_election: list[cdm_legaldocumentation_csa_TerminationCurrencyElection_schema.TerminationCurrencyElection] | None = Field(
