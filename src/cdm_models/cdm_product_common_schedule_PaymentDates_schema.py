...
#   filename:  cdm-product-common-schedule-PaymentDates.schema.json
...
from . import (
    ...
    cdm_product_common_schedule_PayRelativeToEnum_schema,
    cdm_product_common_schedule_PaymentDateSchedule_schema,
)


class PaymentDates(BaseModel):
    payment_frequency: cdm_base_datetime_Frequency_schema.Frequency | None = Field(
        None,
    ...
    first_payment_date: str | None = Field(
        None,
    ...
    last_regular_payment_date: str | None = Field(
        None,
    ...
    payment_days_offset: cdm_base_datetime_Offset_schema.Offset | None = Field(
        None,
