...
from . import cdm_legaldocumentation_csa_IneligibleCreditSupport_schema, com_rosetta_model_metafields_FieldWithMetaString_schema


class CreditSupportObligationsVariationMargin(BaseModel):
    ineligible_credit_support: cdm_legaldocumentation_csa_IneligibleCreditSupport_schema.IneligibleCreditSupport | None = Field(
        None,
