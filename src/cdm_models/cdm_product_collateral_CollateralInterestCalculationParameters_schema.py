...
class CollateralInterestCalculationParameters(BaseModel):
    fixed_rate: float | None = Field(None, alias="fixedRate", description="Specifies the applicable fixed rate  if used.")
    floating_rate: cdm_product_collateral_CollateralAgreementFloatingRate_schema.CollateralAgreementFloatingRate | None = Field(
    ...
    compounding_type: cdm_base_datetime_CompoundingTypeEnum_schema.CompoundingTypeEnum | None = Field(
        None, alias="compoundingType", description="Specifies the type of compounding to be applied (None, Business, Calendar)."
    )
    compounding_business_center: list[cdm_base_datetime_BusinessCenterEnum_schema.BusinessCenterEnum] | None = Field(
        None, alias="compoundingBusinessCenter", description="Specifies the applicable business centers for compounding.", min_length=0
    )
    ...
    withholding_tax_rate: float | None = Field(
        None, alias="withholdingTaxRate", description="Specifies the withholding tax rate if a withholding tax is applicable."
    )
