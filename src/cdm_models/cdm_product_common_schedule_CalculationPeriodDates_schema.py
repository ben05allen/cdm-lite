...
class CalculationPeriodDates(BaseModel):
    ...
    calculation_period_dates_adjustments: cdm_base_datetime_BusinessDayAdjustments_schema.BusinessDayAdjustments | None = Field(
        None,
    ...
    calculation_period_frequency: cdm_base_datetime_CalculationPeriodFrequency_schema.CalculationPeriodFrequency | None = Field(
        None,
