...
class BasketReferenceInformation(BaseModel):
    ...
    nth_to_default: int | None = Field(None, alias="nthToDefault", description="N th reference obligation to default triggers payout.")
    mth_to_default: int | None = Field(
        None, alias="mthToDefault", description="M th reference obligation to default to allow representation of N th to M th defaults."
    )
