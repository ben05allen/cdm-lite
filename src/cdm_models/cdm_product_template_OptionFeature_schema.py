...
class OptionFeature(BaseModel):
    ...
    barrier: cdm_product_template_Barrier_schema.Barrier | None = Field(
        None, description="Specifies a barrier feature."
    )
    knock: cdm_product_template_Knock_schema.Knock | None = Field(
        None, description="Specifies a knock in or knock out feature."
    )
