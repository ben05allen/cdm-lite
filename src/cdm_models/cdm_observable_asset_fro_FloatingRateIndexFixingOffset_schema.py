...
#   filename:  cdm-observable-asset-fro-FloatingRateIndexFixingOffset.schema.json
...
class FloatingRateIndexFixingOffset(BaseModel):
    ...
    designated_maturity: str | None = Field(
        None, alias="designatedMaturity", description="Allows a reason to be specified for using the alternative fixing offset."
    )
