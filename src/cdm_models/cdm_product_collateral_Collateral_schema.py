...
class Collateral(BaseModel):
    independent_amount: cdm_product_collateral_IndependentAmount_schema.IndependentAmount | None = Field(
        None,
    ...
    portfolio_identifier: list[cdm_base_staticdata_identifier_Identifier_schema.Identifier] | None = Field(
        None,
    ...
    collateral_portfolio: (
        list[cdm_event_common_metafields_ReferenceWithMetaCollateralPortfolio_schema.ReferenceWithMetaCollateralPortfolio] | None
    ) = Field(
        None,
    ...
    collateral_provisions: cdm_product_collateral_CollateralProvisions_schema.CollateralProvisions | None = Field(
        None, alias="collateralProvisions", description="specifies the collateral provisions of the product."
    )
