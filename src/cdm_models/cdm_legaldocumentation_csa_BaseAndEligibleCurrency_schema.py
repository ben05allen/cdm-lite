...
from . import cdm_base_staticdata_asset_common_ISOCurrencyCodeEnum_schema, com_rosetta_model_metafields_FieldWithMetaString_schema
...
class BaseAndEligibleCurrency(BaseModel):
    ...
    eligible_currency: list[cdm_base_staticdata_asset_common_ISOCurrencyCodeEnum_schema.ISOCurrencyCodeEnum] | None = Field(
        None,
