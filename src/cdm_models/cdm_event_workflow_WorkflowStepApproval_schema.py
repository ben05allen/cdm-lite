...
class WorkflowStepApproval(BaseModel):
    ...
    rejected_reason: str | None = Field(
        None, alias="rejectedReason", description="Optional reason for rejecting the workflow step"
    )
    timestamp: cdm_event_workflow_EventTimestamp_schema.EventTimestamp = Field(
