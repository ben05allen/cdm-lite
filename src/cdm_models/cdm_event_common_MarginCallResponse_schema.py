...
class MarginCallResponse(BaseModel):
    ...
    call_agreement_type: cdm_legaldocumentation_common_AgreementName_schema.AgreementName | None = Field(
        None, alias="callAgreementType", description="Specifies the legal agreement type the margin call is generated from and governed by."
    )
    ...
    agreement_threshold: cdm_observable_asset_Money_schema.Money | None = Field(
        None, alias="agreementThreshold", description="Specifies the collateral legal agreement threshold amount in base currency."
    )
    agreement_rounding: cdm_observable_asset_Money_schema.Money | None = Field(
        None, alias="agreementRounding", description="Specifies the collateral legal agreement rounding in base currency."
    )
    ...
    collateral_portfolio: (
        cdm_event_common_metafields_ReferenceWithMetaCollateralPortfolio_schema.ReferenceWithMetaCollateralPortfolio | None
    ) = Field(
        None,
    ...
    margin_call_response_action: list[cdm_event_common_MarginCallResponseAction_schema.MarginCallResponseAction] | None = Field(
        None,
