...
#   filename:  cdm-event-common-MarginCallExposure.schema.json
...
from . import (
    ...
    cdm_event_common_Exposure_schema,
...
class MarginCallExposure(BaseModel):
    ...
    base_currency_exposure: MarginCallExposure | None = Field(
        None,
    ...
    overall_exposure: cdm_event_common_Exposure_schema.Exposure = Field(
        ...,
        alias="overallExposure",
    ...
    simm_im_exposure: cdm_event_common_Exposure_schema.Exposure | None = Field(
        None, alias="simmIMExposure", description="Represents Initial Margin (IM) exposure derived from ISDA SIMM calculation."
    )
    schedule_grid_im_exposure: cdm_event_common_Exposure_schema.Exposure | None = Field(
        None,
        alias="scheduleGridIMExposure",
