...
#   filename:  cdm-base-datetime-RelativeDates.schema.json
...
class RelativeDates(BaseModel):
    ...
    schedule_bounds: cdm_base_datetime_DateRange_schema.DateRange | None = Field(
        None,
        alias="scheduleBounds",
