...
class ExerciseInstruction(BaseModel):
    ...
    exercise_option: cdm_product_template_metafields_ReferenceWithMetaOptionPayout_schema.ReferenceWithMetaOptionPayout | None = Field(
        None, alias="exerciseOption", description="Specifies the Option Payout being exercised on the trade."
    )
...
class PrimitiveInstruction(BaseModel):
    contract_formation: cdm_event_common_ContractFormationInstruction_schema.ContractFormationInstruction | None = Field(
        None, alias="contractFormation", description="Specifies instructions describing an contract formation primitive event."
    )
    ...
    exercise: ExerciseInstruction | None = Field(None, description="Specifies instructions describing an exercise primitive event.")
    ...
    quantity_change: cdm_event_common_QuantityChangeInstruction_schema.QuantityChangeInstruction | None = Field(
        None, alias="quantityChange", description="Specifies instructions describing an quantity change primitive event."
    )
    ...
    split: SplitInstruction | None = Field(None, description="Specifies instructions to split a trade into multiple branches.")
    ...
    index_transition: cdm_event_common_IndexTransitionInstruction_schema.IndexTransitionInstruction | None = Field(
        None, alias="indexTransition", description="Specifies inputs needed to process a Index Transition business event."
    )
