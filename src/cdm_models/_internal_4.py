...
class CollateralCriteria(BaseModel):
    ...
    negative_criteria: NegativeCriteria | None = Field(
        None, alias="NegativeCriteria", description="Enables a single Collateral Criteria to be excluded using NOT logic."
    )
    collateral_issuer_type: cdm_base_staticdata_asset_common_CollateralIssuerType_schema.CollateralIssuerType | None = Field(
        None, alias="CollateralIssuerType", description="Criteria is the type of entity issuing the asset."
    )
    ...
    sovereign_agency_rating: cdm_product_collateral_SovereignAgencyRating_schema.SovereignAgencyRating | None = Field(
        None, alias="SovereignAgencyRating", description="Criteria is the agency rating(s) of the country of the issuer."
    )
    ...
    counterparty_own_issue_permitted: cdm_product_collateral_CounterpartyOwnIssuePermitted_schema.CounterpartyOwnIssuePermitted | None = (
        Field(None, alias="CounterpartyOwnIssuePermitted", description="Criteria includes collateral issued by the counterparty.")
    )
    domestic_currency_issued: cdm_product_collateral_DomesticCurrencyIssued_schema.DomesticCurrencyIssued | None = Field(
        None,
