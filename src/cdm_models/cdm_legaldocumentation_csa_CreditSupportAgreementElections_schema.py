...
class CreditSupportAgreementElections(BaseModel):
    ...
    covered_transactions: cdm_legaldocumentation_csa_CoveredTransactions_schema.CoveredTransactions = Field(
        ..., alias="coveredTransactions", description="The specification of transactions covered by the terms of the agreement."
    )
    ...
    exchange_date: str | None = Field(
        None, alias="exchangeDate", description="The bespoke exchange date terms that might be specified by the parties to the agreement."
    )
    ...
    other_eligible_and_posted_support: cdm_legaldocumentation_csa_OtherEligibleAndPostedSupport_schema.OtherEligibleAndPostedSupport = (
        Field(
            ...,
    ...
    ) = Field(None, alias="appropriatedCollateralValuation", description="The election for the Valuation of Appropriate Collateral.")
