...
#   filename:  cdm-observable-asset-ForeignExchangeRateIndex.schema.json
...
from . import (
    ...
    cdm_observable_asset_metafields_FieldWithMetaQuotedCurrencyPair_schema,
...
class ForeignExchangeRateIndex(BaseModel):
    ...
    quoted_currency_pair: cdm_observable_asset_metafields_FieldWithMetaQuotedCurrencyPair_schema.FieldWithMetaQuotedCurrencyPair = Field(
        ..., alias="quotedCurrencyPair", description="Describes the composition of a rate that has been quoted or is to be quoted."
    )
    primary_fx_spot_rate_source: cdm_observable_asset_InformationSource_schema.InformationSource = Field(
        ..., alias="primaryFxSpotRateSource", description="Specifies the primary source from which a rate should be observed."
    )
