...
class BusinessCenters(BaseModel):
    business_center: list[cdm_base_datetime_metafields_FieldWithMetaBusinessCenterEnum_schema.FieldWithMetaBusinessCenterEnum] | None = (
        Field(
            None,
    ...
    commodity_business_calendar: (
        list[cdm_base_datetime_metafields_FieldWithMetaCommodityBusinessCalendarEnum_schema.FieldWithMetaCommodityBusinessCalendarEnum]
        | None
