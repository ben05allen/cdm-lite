...
#   filename:  cdm-product-common-settlement-SettlementTerms.schema.json
#   timestamp: 2026-05-07T14:39:41+00:00

from pydantic import BaseModel, Field
from . import (
    cdm_product_common_settlement_CashSettlementTerms_schema,
    cdm_product_common_settlement_PhysicalSettlementTerms_schema,
...
class SettlementTerms(BaseModel):
    ...
    transfer_settlement_type: cdm_product_common_settlement_TransferSettlementEnum_schema.TransferSettlementEnum | None = Field(
        None, alias="transferSettlementType", description="The qualification as to how the transfer will settle, e.g. a DvP settlement."
    )
    ...
    settlement_centre: cdm_product_common_settlement_SettlementCentreEnum_schema.SettlementCentreEnum | None = Field(
        None, alias="settlementCentre", description="Optional settlement centre as an enumerated list: Euroclear, Clearstream."
    )
    ...
    standard_settlement_style: cdm_product_common_settlement_StandardSettlementStyleEnum_schema.StandardSettlementStyleEnum | None = Field(
        None, alias="standardSettlementStyle", description="Settlement Style."
    )
    cash_settlement_terms: list[cdm_product_common_settlement_CashSettlementTerms_schema.CashSettlementTerms] | None = Field(
        None,
        alias="cashSettlementTerms",
        description="Specifies the parameters associated with the cash settlement procedure.",
        min_length=0,
    )
    physical_settlement_terms: cdm_product_common_settlement_PhysicalSettlementTerms_schema.PhysicalSettlementTerms | None = Field(
        None, alias="physicalSettlementTerms", description="Specifies the physical settlement terms which apply to the transaction."
    )
