...
class Reset(BaseModel):
    ...
    reset_date: str = Field(..., alias="resetDate", description="Specifies the date on which the reset occurred.")
    ...
    observations: list[cdm_observable_event_metafields_ReferenceWithMetaObservation_schema.ReferenceWithMetaObservation] | None = Field(
        None,
    ...
    averaging_methodology: cdm_product_template_AveragingCalculation_schema.AveragingCalculation | None = Field(
        None,
