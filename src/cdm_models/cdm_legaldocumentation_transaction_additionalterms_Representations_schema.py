...
class Representations(BaseModel):
    ...
    agreements_regarding_hedging: bool = Field(
        ..., alias="agreementsRegardingHedging", description="If true, then agreements regarding hedging are applicable."
    )
    ...
    additional_acknowledgements: bool | None = Field(
        None, alias="additionalAcknowledgements", description="If true, then additional acknowledgements are applicable."
    )
