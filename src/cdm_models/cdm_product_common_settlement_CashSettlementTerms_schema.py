...
class CashSettlementTerms(BaseModel):
    cash_settlement_method: cdm_product_common_settlement_CashSettlementMethodEnum_schema.CashSettlementMethodEnum | None = Field(
        None, alias="cashSettlementMethod", description="Specifies the type of cash settlement method: cash price, yield curve etc."
    )
