...
class Restructuring(BaseModel):
    ...
    restructuring_type: cdm_observable_event_metafields_FieldWithMetaRestructuringEnum_schema.FieldWithMetaRestructuringEnum | None = Field(
        None, alias="restructuringType", description="Specifies the type of restructuring that is applicable."
    )
