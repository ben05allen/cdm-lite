...
from . import cdm_legaldocumentation_csa_ExceptionEnum_schema, cdm_legaldocumentation_csa_SimmExceptionApplicableEnum_schema
...
class SimmException(BaseModel):
    ...
    simm_exception_applicable: cdm_legaldocumentation_csa_SimmExceptionApplicableEnum_schema.SimmExceptionApplicableEnum | None = Field(
        None,
