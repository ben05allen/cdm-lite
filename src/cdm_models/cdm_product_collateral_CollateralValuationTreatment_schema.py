...
#   filename:  cdm-product-collateral-CollateralValuationTreatment.schema.json
#   timestamp: 2026-05-07T14:39:41+00:00

from pydantic import BaseModel, Field


class CollateralValuationTreatment(BaseModel):
    haircut_percentage: float | None = Field(
        None,
