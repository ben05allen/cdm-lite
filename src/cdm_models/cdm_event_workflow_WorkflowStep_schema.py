...
class WorkflowStep(BaseModel):
    ...
    ) = Field(None, alias="counterpartyPositionBusinessEvent", description="Documents the life cycle event for a position.")
    ...
    previous_workflow_step: cdm_event_workflow_metafields_ReferenceWithMetaWorkflowStep_schema.ReferenceWithMetaWorkflowStep | None = Field(
        None,
    ...
    next_event: cdm_event_workflow_EventInstruction_schema.EventInstruction | None = Field(
        None, alias="nextEvent", description="The intended next event can be specified, even if the instructions are not known yet."
    )
    ...
    timestamp: list[cdm_event_workflow_EventTimestamp_schema.EventTimestamp] | None = Field(
        None, description="The set of timestamp(s) associated with the event as a collection of [dateTime, qualifier].", min_length=1
    )
