...
from . import cdm_base_math_MoneyRange_schema, cdm_base_math_NumberRange_schema, cdm_product_collateral_ConcentrationLimitCriteria_schema


class ConcentrationLimit(BaseModel):
    concentration_limit_criteria: cdm_product_collateral_ConcentrationLimitCriteria_schema.ConcentrationLimitCriteria | None = Field(
        None,
