...
class InflationRateSpecification(BaseModel):
    ...
    calculation_method: cdm_observable_asset_calculatedrate_InflationCalculationMethodEnum_schema.InflationCalculationMethodEnum | None = (
        Field(
            None,
    ...
    calculation_style: cdm_observable_asset_calculatedrate_InflationCalculationStyleEnum_schema.InflationCalculationStyleEnum | None = (
        Field(
            None,
    ...
    final_principal_exchange_calculation: (
        ...
        None, alias="finalPrincipalExchangeCalculation", description="To be specified only for products that embed a redemption payment."
    )
