...
from . import cdm_legaldocumentation_csa_FrenchLawAddendum_schema, cdm_legaldocumentation_csa_JapaneseSecuritiesProvisions_schema


class JurisdictionRelatedTerms(BaseModel):
    japanese_securities_provisions: cdm_legaldocumentation_csa_JapaneseSecuritiesProvisions_schema.JapaneseSecuritiesProvisions | None = (
    ...
    jury_waiver: bool | None = Field(None, alias="juryWaiver", description="The Jury Waiver conditions specific to the agreement.")
