...
#   filename:  cdm-observable-asset-OtherIndex.schema.json
...
class OtherIndex(BaseModel):
    ...
    description: str | None = Field(None, description="A description that defines the OtherIndex.")
