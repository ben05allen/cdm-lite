...
#   filename:  cdm-product-common-settlement-PhysicalSettlementTerms.schema.json
#   timestamp: 2026-05-07T14:39:41+00:00

from pydantic import BaseModel, Field
from . import (
    cdm_base_staticdata_party_AncillaryRoleEnum_schema,
    cdm_product_common_settlement_DeliverableObligations_schema,
    cdm_product_common_settlement_PhysicalSettlementPeriod_schema,
)


class PhysicalSettlementTerms(BaseModel):
    cleared_physical_settlement: bool | None = Field(
        None,
        alias="clearedPhysicalSettlement",
    ...
    predetermined_clearing_organization_party: cdm_base_staticdata_party_AncillaryRoleEnum_schema.AncillaryRoleEnum | None = Field(
        None,
        alias="predeterminedClearingOrganizationParty",
        description="Specifies the clearing organization (CCP, DCO) to which the trade should be cleared.",
    )
    physical_settlement_period: cdm_product_common_settlement_PhysicalSettlementPeriod_schema.PhysicalSettlementPeriod | None = Field(
        None,
    ...
    deliverable_obligations: cdm_product_common_settlement_DeliverableObligations_schema.DeliverableObligations | None = Field(
        None,
        alias="deliverableObligations",
        description="This element contains all the ISDA terms relevant to defining the deliverable obligations.",
    )
    escrow: bool | None = Field(
        None,
    ...
    sixty_business_day_settlement_cap: bool | None = Field(
        None,
        alias="sixtyBusinessDaySettlementCap",
