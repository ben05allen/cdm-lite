...
class SecurityProviderRightsEvent(BaseModel):
    party_election: (
        list[cdm_legaldocumentation_csa_SecurityProviderRightsEventElection_schema.SecurityProviderRightsEventElection] | None
    ...
    automatic_set_off: bool | None = Field(
        None, alias="automaticSetOff", description="The Automatic Set-Off provision applies when the value is set to True."
    )
