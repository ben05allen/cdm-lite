...
class ThresholdRatingsBased(BaseModel):
    ...
    variable_set: (
        list[cdm_legaldocumentation_csa_CSAThresholdVariableSet_schema.CSAThresholdVariableSet]
        | None
    ) = Field(
        None,
        alias="variableSet",
    ...
    rated_party: (
        cdm_legaldocumentation_csa_ThresholdRatedPartyEnum_schema.ThresholdRatedPartyEnum | None
    ...
    event: (
        list[cdm_legaldocumentation_csa_ThresholdZeroEventEnum_schema.ThresholdZeroEventEnum] | None
    ) = Field(
