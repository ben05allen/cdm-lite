...
class FallbackReferencePrice(BaseModel):
    ...
    fall_back_settlement_rate_option: (
        list[cdm_observable_asset_metafields_FieldWithMetaSettlementRateOptionEnum_schema.FieldWithMetaSettlementRateOptionEnum] | None
    ) = Field(
        None, alias="fallBackSettlementRateOption", description="This settlement rate option will be used in its place.", min_length=0
    )
