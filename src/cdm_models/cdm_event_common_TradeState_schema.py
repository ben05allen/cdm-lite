...
class TradeState(BaseModel):
    ...
    state: cdm_event_common_State_schema.State | None = Field(None, description="Represents the State of the Trade through its life-cycle.")
    ...
    valuation_history: list[cdm_event_common_Valuation_schema.Valuation] | None = Field(None, alias="valuationHistory", min_length=0)
