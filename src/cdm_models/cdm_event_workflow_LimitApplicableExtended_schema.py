...
#   filename:  cdm-event-workflow-LimitApplicableExtended.schema.json
...
from . import (
    ...
    cdm_event_workflow_metafields_FieldWithMetaLimitLevelEnum_schema,
    com_rosetta_model_metafields_FieldWithMetaString_schema,
)


class LimitApplicableExtended(BaseModel):
    limit_type: cdm_event_workflow_metafields_FieldWithMetaCreditLimitTypeEnum_schema.FieldWithMetaCreditLimitTypeEnum | None = Field(
        None,
        alias="limitType",
    ...
    limit_level: cdm_event_workflow_metafields_FieldWithMetaLimitLevelEnum_schema.FieldWithMetaLimitLevelEnum | None = Field(
        None,
        alias="limitLevel",
    ...
    limit_impact_due_to_trade: float | None = Field(
        None,
        alias="limitImpactDueToTrade",
