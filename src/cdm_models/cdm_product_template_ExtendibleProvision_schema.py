...
#   filename:  cdm-product-template-ExtendibleProvision.schema.json
...
from . import (
    ...
    cdm_product_template_ExtendibleProvisionAdjustedDates_schema,
)
...
class ExtendibleProvision(BaseModel):
    ...
    calling_party: cdm_product_template_CallingPartyEnum_schema.CallingPartyEnum | None = Field(None, alias="callingParty")
    ...
    extension_period: cdm_base_datetime_AdjustableRelativeOrPeriodicDates_schema.AdjustableRelativeOrPeriodicDates | None = Field(
        None, alias="extensionPeriod", description="The period within which notice can be given that the contract will be extended."
    )
