...
class InterestRatePayout(BaseModel):
    ...
    payment_date: cdm_base_datetime_AdjustableDate_schema.AdjustableDate | None = Field(
        None, alias="paymentDate", description="The payment date, where only one date is specified, as for the FRA product."
    )
    ...
    bond_reference: cdm_product_asset_BondReference_schema.BondReference | None = Field(
        None, alias="bondReference", description="Reference to a bond underlier to represent an asset swap or Condition Precedent Bond."
    )
    ...
    spread_calculation_method: cdm_product_asset_SpreadCalculationMethodEnum_schema.SpreadCalculationMethodEnum | None = Field(
        None,
