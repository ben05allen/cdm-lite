...
from . import cdm_base_datetime_AdjustableRelativeOrPeriodicDates_schema, cdm_product_common_settlement_PrincipalPayment_schema
...
class PrincipalPaymentSchedule(BaseModel):
    ...
    intermediate_principal_payment: cdm_base_datetime_AdjustableRelativeOrPeriodicDates_schema.AdjustableRelativeOrPeriodicDates | None = (
        Field(
            None,
