...
from . import cdm_base_datetime_AdjustableRelativeOrPeriodicDates_schema, cdm_product_asset_FPVFinalPriceElectionFallbackEnum_schema
...
class ValuationTerms(BaseModel):
    ...
    dividend_valuation_dates: cdm_base_datetime_AdjustableRelativeOrPeriodicDates_schema.AdjustableRelativeOrPeriodicDates | None = Field(
        None, alias="dividendValuationDates", description="Specifies the dividend valuation dates of the swap."
    )
