...
class Resource(BaseModel):
    ...
    resource_type: cdm_legaldocumentation_common_metafields_FieldWithMetaResourceTypeEnum_schema.FieldWithMetaResourceTypeEnum | None = (
    ...
    name: str | None = Field(None, description="The name of the resource.  It is specified as a NormalizedString in FpML.")
