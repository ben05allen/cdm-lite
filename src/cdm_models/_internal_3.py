...
class CommodityPayout(BaseModel):
    payer_receiver: cdm_base_staticdata_party_PayerReceiver_schema.PayerReceiver | None = Field(
        None, alias="payerReceiver", description="Canonical representation of the payer and receiver parties applicable to each payout leg."
    )
    ...
    averaging_feature: cdm_product_template_AveragingCalculation_schema.AveragingCalculation | None = Field(
        None, alias="averagingFeature", description="Indicates if the averaging calculation, when applicable, is weighted or unweighted."
    )
    commodity_price_return_terms: cdm_product_common_settlement_CommodityPriceReturnTerms_schema.CommodityPriceReturnTerms | None = Field(
        None, alias="commodityPriceReturnTerms", description="Defines parameters in which the commodity price is assessed."
    )
    ...
    calculation_period_dates: cdm_product_common_schedule_CalculationPeriodDates_schema.CalculationPeriodDates | None = Field(
        None, alias="calculationPeriodDates", description="Defines the calculation period dates schedule."
    )
    ...
    fx_feature: cdm_product_template_FxFeature_schema.FxFeature | None = Field(
        None, alias="fxFeature", description="Defines quanto or composite FX features that are included in the swap leg."
    )
...
class NonTransferableProduct(BaseModel):
    identifier: list[cdm_base_staticdata_asset_common_ProductIdentifier_schema.ProductIdentifier] | None = Field(
        None, description="Comprises a identifier and a source to uniquely identify the nonTransferableProduct. ", min_length=0
    )
    taxonomy: list[cdm_base_staticdata_asset_common_ProductTaxonomy_schema.ProductTaxonomy] | None = Field(
        None, description="Specifies the product taxonomy, which is composed of a taxonomy value and a taxonomy source.", min_length=0
    )
...
class OptionPayout(BaseModel):
    ...
    strike: cdm_product_template_OptionStrike_schema.OptionStrike | None = Field(None, description="Specifies the strike of the option")
...
class Payout(BaseModel):
    ...
    fixed_price_payout: cdm_product_template_FixedPricePayout_schema.FixedPricePayout | None = Field(
        None, alias="FixedPricePayout", description="Defines a payout in which one or more payouts are defined as a fixed price."
    )
...
class PerformancePayout(BaseModel):
    ...
    fx_feature: list[cdm_product_template_FxFeature_schema.FxFeature] | None = Field(
        None, alias="fxFeature", description="Defines quanto or composite FX features that are included in the swap leg.", min_length=0
    )
...
class Underlier(BaseModel):
    observable: cdm_observable_asset_metafields_ReferenceWithMetaObservable_schema.ReferenceWithMetaObservable | None = Field(
        None, alias="Observable", description="Specifies the object to be observed for a price, it could be an asset or a reference."
    )
    product: Product | None = Field(
        None, alias="Product", description="Enables either a TransferableProduct or a NonTransferableProduct to be used in an underlier."
    )
