...
class CommodityPayout(BaseModel):
    ...
    commodity_price_return_terms: (
        cdm_product_common_settlement_CommodityPriceReturnTerms_schema.CommodityPriceReturnTerms
        | None
    ) = Field(
        None,
    ...
    delivery: cdm_product_asset_AssetDeliveryInformation_schema.AssetDeliveryInformation | None = (
        Field(None, description="Contains the information relative to the delivery of the asset.")
    )
...
class EconomicTerms(BaseModel):
    ...
    termination_provision: (
        cdm_product_template_TerminationProvision_schema.TerminationProvision | None
    ) = Field(
        None,
...
class NonTransferableProduct(BaseModel):
    identifier: (
        list[cdm_base_staticdata_asset_common_ProductIdentifier_schema.ProductIdentifier] | None
    ) = Field(
        None,
...
class OptionPayout(BaseModel):
    ...
    buyer_seller: cdm_base_staticdata_party_BuyerSeller_schema.BuyerSeller = Field(
        ..., alias="buyerSeller"
    )
    ...
    observation_terms: (
        cdm_product_common_schedule_ObservationTerms_schema.ObservationTerms | None
    ) = Field(
        None,
...
class Payout(BaseModel):
    ...
    commodity_payout: CommodityPayout | None = Field(
        None,
        alias="CommodityPayout",
        description="Defines the payout for the floating leg of a Commodity Swap.",
    )
    credit_default_payout: (
        cdm_product_asset_CreditDefaultPayout_schema.CreditDefaultPayout | None
    ) = Field(
        None,
    ...
    fixed_price_payout: cdm_product_template_FixedPricePayout_schema.FixedPricePayout | None = (
        Field(
            None,
    ...
    interest_rate_payout: cdm_product_asset_InterestRatePayout_schema.InterestRatePayout | None = (
        Field(
            None,
    ...
    option_payout: OptionPayout | None = Field(
        None, alias="OptionPayout", description="The option payout."
    )
...
class PerformancePayout(BaseModel):
    ...
    portfolio_return_terms: (
        list[cdm_product_template_PortfolioReturnTerms_schema.PortfolioReturnTerms] | None
    ) = Field(
        None,
...
class Underlier(BaseModel):
    observable: (
        cdm_observable_asset_metafields_ReferenceWithMetaObservable_schema.ReferenceWithMetaObservable
        | None
    ) = Field(
        None,
        alias="Observable",
