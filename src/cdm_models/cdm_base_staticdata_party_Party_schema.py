...
class Party(BaseModel):
    party_id: list[cdm_base_staticdata_party_PartyIdentifier_schema.PartyIdentifier] | None = Field(
        None, alias="partyId", description="The identifier associated with a party, e.g. the 20 digits LEI code.", min_length=1
    )
    name: com_rosetta_model_metafields_FieldWithMetaString_schema.FieldWithMetaString | None = Field(None, description="The party name.")
