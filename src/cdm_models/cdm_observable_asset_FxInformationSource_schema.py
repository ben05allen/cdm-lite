...
class FxInformationSource(BaseModel):
    source_provider: (
        cdm_observable_asset_metafields_FieldWithMetaInformationProviderEnum_schema.FieldWithMetaInformationProviderEnum | None
    ) = Field(
        None,
    ...
    fixing_time: cdm_base_datetime_BusinessCenterTime_schema.BusinessCenterTime | None = Field(
        None, alias="fixingTime", description="The time that the fixing will be taken along with a business center to define the time zone."
    )
