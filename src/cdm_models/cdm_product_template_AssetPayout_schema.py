...
class AssetPayout(BaseModel):
    ...
    trade_type: cdm_product_template_AssetPayoutTradeTypeEnum_schema.AssetPayoutTradeTypeEnum | None = Field(
        None, alias="tradeType", description="The trade type, eg repurchase transaction or buy/sell-back."
    )
