...
#   filename:  cdm-legaldocumentation-csa-MTARatingsBased.schema.json
...
from . import (
    ...
    cdm_legaldocumentation_csa_CSAMTAVariableSet_schema,
    cdm_legaldocumentation_csa_MTARatedPartyEnum_schema,
    cdm_legaldocumentation_csa_MTAZeroEventEnum_schema,
...
class MTARatingsBased(BaseModel):
