...
#   filename:  cdm-event-common-MarginCallIssuance.schema.json
...
class MarginCallIssuance(BaseModel):
    ...
    call_amount_in_base_currency: cdm_observable_asset_Money_schema.Money = Field(
        ...,
        alias="callAmountInBaseCurrency",
