...
class AssetDeliveryProfileBlock(BaseModel):
    start_time: str | None = Field(None, alias="startTime", description="The start time of the delivery interval for each block or shape.")
    end_time: str | None = Field(None, alias="endTime", description="The end time of the delivery interval for each block or shape.")
